    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 440 }}>
          ...
          <h1 style={{ fontSize: 40, lineHeight: 1.1, fontWeight: 600, letterSpacing: "-0.02em", color: "#e7eaf3", margin: "0 0 20px 0" }}>
            The risk-free way to{" "}
            <span style={{ color: "#818cf8" }}>learn the Indian markets.</span>
          </h1>
          <p style={{ fontSize: 14.5, lineHeight: 1.7, color: "rgba(255,255,255,0.55)", margin: "0 0 20px 0" }}>
            Trade Nifty-style instruments with virtual ₹5 lakh, finish 8 levels of curriculum, and earn a verified certificate.
          </p>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 20, fontWeight: 600, letterSpacing: "-0.01em" }}>Create your account</div>
              <div style={{ fontSize: 12.5, color: "rgba(255,255,255,0.45)", marginTop: 4 }}>Three minutes. No card required.</div>
            </div>

            <form onSubmit={(e) => { e.preventDefault(); handleSubmit() }}>
              {/* Username */}
              <div style={{ marginBottom: 12 }}>
                <label style={{ display: "block", fontSize: 12, color: "rgba(255,255,255,0.55)", marginBottom: 6, fontWeight: 500 }}>Username</label>
                <div style={{
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={{ display: "block", fontSize: 12, color: "rgba(255,255,255,0.55)", marginBottom: 4, fontWeight: 500 }}>Password</label>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", marginBottom: 6 }}>At least 8 characters with one number.</div>
                <div style={{
                  display: "flex", alignItems: "center", gap: 8,
                  background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.08)",
                  borderRadius: 8, height: 40, padding: "0 12px",
